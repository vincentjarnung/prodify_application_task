...
class MainsView extends StatefulWidget {
  const MainsView({Key? key}) : super(key: key);

  @override
  _MainsViewState createState() => _MainsViewState();
}

class _MainsViewState extends State<MainsView> {
